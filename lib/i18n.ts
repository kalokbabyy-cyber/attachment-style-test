...
export const copy = {
  en: {
    ...
    unlockButton: "Unlock Full Report - CAD 9.99",
  ...
  es: {
    ...
    unlockButton: "Desbloquear informe - CAD 9.99",
  ...
  pt: {
    ...
    unlockButton: "Desbloquear relatório - CAD 9.99",
  ...
  fr: {
    ...
    unlockButton: "Débloquer le rapport - CAD 9.99",
  ...
  de: {
    ...
    unlockButton: "Bericht freischalten - CAD 9.99",
  ...
  ko: {
    ...
    unlockButton: "전체 리포트 열기 - CAD 9.99",
